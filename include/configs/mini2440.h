...
#define CONFIG_BOOTARGS		"noinitrd root=/dev/mtdblock3 console=ttySAC0,115200 init=/linuxrc"
...
#define	CONFIG_SYS_PROMPT		"[u-boot@AT2440EVB]# "	/* Monitor Command Prompt	*/
